#pragma checksum "C:\Users\Skants\Source\Repos\CabinPlanner\CabinPlanner.App\Views\CabinsDetailPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "B585620F05490D01A901CEA126CB8C0B"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace CabinPlanner.App.Views
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            ICabinsDetailPage_Bindings
        {
            ...
            private void Update_ViewModel_Item(global::CabinPlanner.Model.CabinUser obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | DATA_CHANGED | (1 << 0))) != 0)
                    {
                        this.Update_ViewModel_Item_Cabin(obj.Cabin, phase);
                    }
                }
            }
            private void Update_ViewModel_Item_Cabin(global::CabinPlanner.Model.Cabin obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | DATA_CHANGED | (1 << 0))) != 0)
                    {
                        this.Update_ViewModel_Item_Cabin_CabinName(obj.CabinName, phase);
                    }
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_ViewModel_Item_Cabin_CabinOwner(obj.CabinOwner, phase);
                    }
                }
            }
            private void Update_ViewModel_Item_Cabin_CabinName(global::System.String obj, int phase)
            {
            ...
            private void Update_ViewModel_Item_Cabin_CabinOwner(global::CabinPlanner.Model.Person obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
